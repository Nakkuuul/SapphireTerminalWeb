...
const Filter: React.FC<FilterProps> = ({
  ...
  return (
    <div className="relative">
      <button 
        className={`flex items-center gap-1 px-4 h-14 rounded-lg border ${
      ...
      {showFilters && (
        <div className="absolute left-0 z-20 mt-1 w-64 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
          <div className="py-1">
