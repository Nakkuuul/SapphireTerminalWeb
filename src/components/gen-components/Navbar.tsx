              ...
              <div className="hidden md:flex items-center space-x-4">
                <div className="flex flex-col">
                  <div className="flex items-center">
                    ...
                    <span className="ml-2 text-xs text-white bg-red-500 px-1 py-0.5 rounded-sm">Expiry Today</span>
                  </div>
                  <div className="flex items-center mt-0.5">
                    <span className="text-xs text-gray-800">78,158.40</span>
                    <span className="ml-1 text-xs text-green-500">+87.10 (0.10%)</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center mt-0.5">
                    <span className="text-xs text-gray-800">78,158.40</span>
                    <span className="ml-1 text-xs text-red-500">-87.10 (-0.10%)</span>
                  </div>
                </div>
              </div>
            </div>
