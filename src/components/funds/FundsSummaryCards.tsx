  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: `
          linear-gradient(90deg, #D1D5DB 10px, transparent 10px, transparent 20px),
          linear-gradient(270deg, #D1D5DB 10px, transparent 10px, transparent 20px),
          linear-gradient(180deg, #D1D5DB 10px, transparent 10px, transparent 20px),
          linear-gradient(0deg, #D1D5DB 10px, transparent 10px, transparent 20px)
        `,
      ...
      {/* Content */}
      <div className="bg-[#F4F4F9] rounded-lg p-6">
