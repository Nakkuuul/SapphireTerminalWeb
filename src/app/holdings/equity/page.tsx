          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead>
              <tr className="bg-gray-50">
                <th className="px-4 py-2 text-left text-base font-medium border-r">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
                ...
                <tr key={index}>
                  <td className="px-4 py-2 whitespace-nowrap border-r">
                    <div className="flex items-center">
                      ...
                      <MoreHorizontal className="ml-2 w-3 h-3 text-gray-400" />
                    </div>
                  </td>
                  <td className="px-4 py-2 text-[#6B7280] whitespace-nowrap border-r" style={{ fontSize: '14px' }}>{holding.quantity}</td>
                  <td className="px-4 py-2 text-[#6B7280] whitespace-nowrap border-r" style={{ fontSize: '14px' }}>{formatCurrency(holding.avgPrice)}</td>
              ...
              <tr className="bg-gray-50 font-medium">
                <td className="px-4 py-2 whitespace-nowrap border-r" style={{ fontSize: '14px' }}>Total</td>
                <td className="px-4 py-2 whitespace-nowrap border-r"></td>
                <td className="px-4 py-2 whitespace-nowrap border-r"></td>
                <td className="px-4 py-2 whitespace-nowrap border-r"></td>
                <td className="px-4 py-2 text-[#6B7280] whitespace-nowrap border-r" style={{ fontSize: '14px' }}>{formatCurrency(totalInvestmentValue)}</td>
                <td className="px-4 py-2 whitespace-nowrap border-r" style={{ fontSize: '14px' }}>
