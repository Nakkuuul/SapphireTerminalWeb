  ...
  const dummyNews = [
    {
      ...
      date: '3 Mar 2025',
      time: '12:56:04',
      description: 'Two analytics firms have jointly analysed the market data industry, concluding that rising costs are unsustainable.CEO Mike Charades warns that vendor price hikes outpace banks and asset managers\' budget growth, making current spending levels unviable. Without adjustments, financial firms may struggle to manage escalating data expenses.',
              ...
              <div className="flex flex-col items-center">
                <button className="p-2 rounded-full bg-[#F4F4F9] flex items-center justify-center text-gray-600">
                  <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M18 7L10.8325 14V10.512C6.30029 9.60429 2.71875 10.6055 0 13.9377C0.47168 7.08355 5.31592 3.77544 10.8325 3.55594V0L18 7Z" fill="black" />
                  </svg>
                </button>
