...
const NewsPage = () => {
  ...
  const dummyNews = [
    {
      ...
      time: "12:56:04",
      description:
        "Two analytics firms have jointly analysed the market data industry, concluding that rising costs are unsustainable.CEO Mike Charades warns that vendor price hikes outpace banks and asset managers' budget growth, making current spending levels unviable. Without adjustments, financial firms may struggle to manage escalating data expenses.",
    ...
    },
    {
      ...
      time: "10:30:22",
      description:
        "Financial experts are raising alarms about the rapidly increasing costs of market data services. As vendors continue to raise prices, many institutions are finding it difficult to justify the expense.",
      source: "Bloomberg",
      imageUrl: "/news.svg",
      likes: 42,
      comments: 15,
    },
    {
      ...
      time: "09:15:45",
      description:
        "A comprehensive analysis of the market data landscape reveals troubling trends as costs continue to escalate faster than inflation.",
    ...
    },
    {
      ...
      time: "14:20:33",
      description:
        "Asset managers across the industry report difficulties in managing the increasing costs of market data while maintaining profitability.",
      source: "Reuters",
      imageUrl: "/news.svg",
      likes: 29,
      comments: 11,
  ...
  useEffect(() => {
    ...
    }, 130); // 150ms = 15 seconds total (100 steps * 150ms = 15s)
  ...
  const toggleReadMore = (newsId: number) => {
  ...
  const renderNewsContent = (newsItem: typeof currentNews) => (
    <>
      ...
      <div className="px-4 pb-6">
        ...
        <div className="text-sm text-gray-500">Source: {newsItem.source}</div>
      </div>
    </>
  );
  ...
  return (
    <div className="mx-auto pb-8">
      <div className="flex flex-col md:flex-row">
        ...
        <div
          className={`w-full mx-auto bg-[#F4F4F9] rounded-lg md:w-2/4 transition-all duration-300 overflow-hidden relative ${
            isEnlarged
              ? "fixed top-0 left-0 w-full h-full bg-white z-50 p-8"
              : "h-[600px]"
          }`}
        >
        ...
        {!isEnlarged && (
          <div className="bottom-0 right-52 z-10">
            <div className="mt-[375px] ml-6 px-2 py-4 gap-y-5 grid grid-row-3">
              ...
              <div className="flex flex-col items-center">
                <button className="p-2 rounded-full bg-[#F4F4F9] flex items-center justify-center text-gray-600">
                  ...
                  >
                    <path
                      d="M9.5 16C10.9834 16 12.4334 15.5601 13.6668 14.736C14.9001 13.9119 15.8614 12.7406 16.4291 11.3701C16.9967 9.99968 17.1453 8.49168 16.8559 7.03682C16.5665 5.58197 15.8522 4.2456 14.8033 3.1967C13.7544 2.14781 12.418 1.4335 10.9632 1.14411C9.50832 0.854725 8.00032 1.00325 6.62987 1.57091C5.25943 2.13856 4.08809 3.09986 3.26398 4.33323C2.43987 5.56659 2 7.01664 2 8.5C2 9.74 2.3 10.9083 2.83333 11.9392L2 16L6.06083 15.1667C7.09083 15.6992 8.26083 16 9.5 16Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                ...
                <button className="p-2 rounded-full bg-[#F4F4F9] flex items-center justify-center text-gray-600">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M18 7L10.8325 14V10.512C6.30029 9.60429 2.71875 10.6055 0 13.9377C0.47168 7.08355 5.31592 3.77544 10.8325 3.55594V0L18 7Z"
                      fill="black"
                    />
                  </svg>
                </button>
      ...
      <style jsx global>{`
        ...
        .animate-slide-up-new {
          animation: slide-up-new 300ms ease-in-out forwards;
        }

        .animate-slide-down-new {
          animation: slide-down-new 300ms ease-in-out forwards;
        }
      `}</style>
    </div>
  );
